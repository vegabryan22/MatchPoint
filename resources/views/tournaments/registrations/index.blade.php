    ...
    <div class="mp-card p-3 p-lg-4">
        ...
        <div class="table-responsive">
            <table class="table align-middle">
                <thead>
                    @if ($tournament->participant_type === App\Enums\ParticipantType::Individual)
                        <tr><th>Jugador</th><th>País</th><th>Nivel</th><th>Origen</th><th>Fecha</th><th class="text-end">Acciones</th></tr>
                    @else
                        <tr><th>Equipo</th><th>Integrantes</th><th>Origen</th><th>Fecha</th><th class="text-end">Acciones</th></tr>
                    @endif
                </thead>
                <tbody>
                @forelse ($participants as $participant)
                    <tr>
                        ...
                        @if ($tournament->participant_type === App\Enums\ParticipantType::Individual)
                            <td>{{ $participant->country }}</td><td>{{ $participant->level->label() }}</td>
                        @else
                ...
                @empty
                    <tr><td colspan="6" class="mp-empty mp-muted">Todavía no hay participantes inscritos.</td></tr>
                @endforelse
                </tbody>
            </table>
        </div>
